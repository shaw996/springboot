...
CREATE TABLE `user` (
  ...
  `phone` CHAR(11) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '用户手机',
...
INSERT INTO `user` (`id`, `username`, `wechat_id`, `nickname`, `password`, `phone`, `email`, `avatar`) VALUES ('2', 'test2', 'test2WechatId', '测试用户2', '123456', '193xxxx5202', 'example@example.com', 'avatar.png');
